...
**In Progress**
<br>**Note:** Relevant information will be made available with a retrospective paper which is being prepared that includes analyses such as gender differences; however, these aspects are not covered in the current prototype. The retrospective paper will be added as an artefact.
:::
...
**Description:** The system is able to inform about specific data inputs that had impact on the outcome.
...
::: {style="background-color: #e8daef; padding:6px 10px; border-radius:5px; display:inline-block;"}
**In Progress**
<br>**Note**: Impact feature has been integrated into the VALIDATE app; i.e., after generating a prediction, users can navigate to a tab showing which input variables most influenced the prediction. App prototype document should be added here as artefact.
:::
...
::: {style="background-color: #e8daef; padding:6px 10px; border-radius:5px; display:inline-block;"}
**In Progress**
<br>**Note:** Current work so far has focused only on SHARP/tabular data. It is uncertain whether further validation, comparison, or user testing will be carried out. Some explainability analyses have been conducted, although they may not have been explicitly documented. Related aspects may also be addressed in the usability study.
:::
