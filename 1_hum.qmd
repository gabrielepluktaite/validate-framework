...
**Description:** ***X*** of ***\[relevant methods\]*** for measuring model uncertainty are implemented to provide a confidence interval for predictions in the app available at ***\[time point\].***
...
\- start of the prospective study. *See page 7 for more detailed information about the time points of phases.*
...
\- ***All*** of relevant methods: ***to be defined by Owner*** for measuring model uncertainty are used to provide a confidence interval for predictions in the app available at ***start of the prospective study***.
