...
**Description:** ***\[relevant methods\]*** for measuring model uncertainty are implemented to provide a confidence level for predictions in the app available at ***\[time point\]***.

| **Parameter**        | **Values**                            |
|----------------------|---------------------------------------|
| **Relevant Methods** | To be defined by Owner                |
| **Time Point**       | By the start of the prospective study |
...
| **Parameter**                 | **Values**                |
+===============================+===========================+
| **Physician Expertise Level** | \- Beginner               |
|                               |                           |
|                               | \- Intermediate           |
|                               |                           |
|                               | \- Expert                 |
