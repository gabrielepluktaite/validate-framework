...
**In progress**
<br>**Note**: This requirement has been addressed in the retrospective validation paper (see Deliverable D2.3). No intersections were identified. Criteria for defining a “typical” patient were established based on relevant clinical guidelines. No intersectional analysis was conducted yet, but will be included. Thus, the retrospective validation paper and D2.3 will be added here as artefacts.
:::
...
::: {style="background-color:#e8daef; padding:6px 10px; border-radius:5px; display:inline-block;"}
**In Progress**
<br>**Note:** System Usability Scale (SUS) questionnaire was distributed to shadowing physicians and clinical physicians who had not previously used the app. Results will be included in Deliverable D3.5 and attached here as artefact. 
<br>**See Artefact:**
