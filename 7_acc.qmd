...
**Description:** Research work produced by the VALIDATE consortium must adhere to ***\[guidelines\]*** as well as ethical norms regarding ***\[relevant aspects\]***. This is implemented by ***\[time point\].***
...
| **Time Point**       | Throughout the project                                                                                             |
...
-   Research work produced by the VALIDATE consortium must adhere to EU Horizon funding guidelines, reporting guidelines, as well as ethical norms regarding ***data availability***. This is implemented ***throughout the project***.

-   Research work produced by the VALIDATE consortium must adhere to EU Horizon funding guidelines, reporting guidelines, as well as ethical norms regarding ***reproducibility***. This is implemented ***throughout the project***.

-   Research work produced by the VALIDATE consortium must adhere to EU Horizon funding guidelines, reporting guidelines, as well as ethical norms regarding ***open access***. This is implemented ***throughout the project***.

-   Research work produced by the VALIDATE consortium must adhere to EU Horizon funding guidelines, reporting guidelines, as well as ethical norms regarding ***distribution***. This is implemented ***throughout the project***.

-   Research work produced by the VALIDATE consortium must adhere to EU Horizon funding guidelines, reporting guidelines, as well as ethical norms regarding ***confidentiality***. This is implemented ***throughout the project***.

-   Research work produced by the VALIDATE consortium must adhere to EU Horizon funding guidelines, reporting guidelines, as well as ethical norms regarding ***originality***. This is implemented ***throughout the project***.
:::
