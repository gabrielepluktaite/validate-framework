...
To Be Done
**Note**: market readiness is not expected before project end.
:::
...
::: {style="background-color:#e6f7ff; padding:10px; border-radius:5px;"}
To Be Done
**Note**: no identified barriers for market entry, but considered high-level and inappropriate for VALIDATE’s outputs.
:::
...
In progress
**Note**: continued iteration of intended use purpose is ongoing; no final intended use purpose is yet defined.
:::
...
::: {style="background-color:#e8daef; padding:10px; border-radius:5px;"}
In progress
**Note**: study protocol will be included in the framework. This is in progress as the recruitment for the study is not complete
:::
...
::: {style="background-color:#e6f7ff; padding:10px; border-radius:5px;"}
To Be Done
**Note**: this requirement has not been started as 23-1-ROB needs to be completed before moving on to this requirement.
:::
