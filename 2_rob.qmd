...
::: {style="background-color:#e6f7ff; padding:10px; border-radius:5px; display:inline-block;"}
**To Be Done**
...
::: {style="background-color:#e8daef; padding:10px; border-radius:5px; display:inline-block;"}
**In progress**
