...
**To Be Done**
<br>**Note**: Research about the relevant ISO norms for uptake and MDR will be included in the Deliverables D5.3 and D5.6. Thus, D5.3 and D5.6 will be added as artefacts. Actual compliance of the prototype with the identified norms is unknown and will not be evaluated within the scope of the project. Some norms are being incorporated into software development, e.g., by WP3. However a systematic assessment will not be completed and is in line with the status of the VALIDATE tool which is not market-ready.
:::
...
::: {style="background-color:#e6f7ff; padding:6px 10px; border-radius:5px; display:inline-block;"}
**To Be Done**
<br>**Note**: no identified barriers for market entry, but considered high-level and inappropriate for VALIDATE’s outputs. The guidelines on cyber security will not be evaluated or complied by the VALIDATE project within its lifetime. There may be some relevant information included in tasks 5.3 and 5.5, which will be led by CUB (WP2 members). 
:::
...
**In progress**
<br>**Note**: continued iteration of intended use purpose is ongoing; no final intended use purpose is yet defined. A risk assessment following the specific ISO norms listed will not be done during the project lifetime.
:::
...
::: {style="background-color:#e8daef; padding:6px 10px; border-radius:5px; display:inline-block;"}
**In progress**
<br>**Note**: The prospective shadowing study currently includes 220–250 patients. Some modified Rankin Scale (mRS) scores are missing, primarily due to follow-up duration limitations. Missing data will be addressed through statistical methods and possibly extended follow-up (e.g., at 4 months). Upon discharge, patients receive an appointment or phone follow-up visit to assess mRS outcomes.
:::
...
::: {style="background-color:#e6f7ff; padding:6px 10px; border-radius:5px; display:inline-block;"}
**Not Completed**
<br>**Note**: RCT will need to compare two groups, one with treatment as provided by the VALIDATE system, following its prognostic recommendations exactly, and a control group receiving standard clinical practice without the VALIDATE app. The ratio and sample size will be determined based on observed accuracy in cases where actual treatment data are available.

The clinical work package lacks statistical expertise. The budget for evaluating the prospective validation study has not yet been released. It was noted that the clinical trial protocol should be reviewed to address: (i) handling of missing data (anticipated at 10% based on previous planning), (ii) recruitment challenges and patient inclusion criteria, (iii) implementation challenges leading to differences between retrospective (not collected in real-time, but collected for prospective patients) and truly prospective data sources. Dealing with missing data and foreseeing implementation challenges, related both to recruitment and technical infrastructure are common issues in clinical validation and should be addressed in advance. 
:::
...
::: {style="background-color:#e8daef; padding:6px 10px; border-radius:5px; display:inline-block;"}
**In Progress**
<br>**Note**: Initial analysis on missing data scenarios has been done in D2.2 pages 54-9. Testing differences of local standards of care has proven challenging due to varying definitions of local standards and descriptors. More work on missingness will be done in a retrospective paper whose results will be included in D2.3. Moreover, some other analyses related to minorities have already been included in D 2.3. Thus, D2.2 and D2.3 will be added as artefacts.
:::
...
::: {style="background-color:#e8daef; padding:6px 10px; border-radius:5px; display:inline-block;"}
**In Progress**
<br>**Note**: Initial version of intended purpose statement is included in Deliverable D3.2. The statement was co-developed through workshops with consortium members. The finalized text still needs to be exported into a formal report.
:::
