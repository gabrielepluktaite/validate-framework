...
**To Be Done**
<br>**Note**: market readiness is not expected before project end.
:::
...
::: {style="background-color:#e8daef; padding:10px; border-radius:5px;"}
**In progress**
<br>**Note**: study protocol will be included in the framework. This is in progress as the recruitment for the study is not complete
:::
...
::: {style="background-color:#e6f7ff; padding:10px; border-radius:5px;"}
**To Be Done**
<br>**Note**: this requirement has not been started as 23-1-ROB needs to be completed before moving on to this requirement.
:::
