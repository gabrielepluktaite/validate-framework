...
\- ***Anonymized prospective study data*** is available for access to ***researchers*** 
 through ***process outlined in VALIDATE data management plan after embargo period***.
...
\- by the start of the validation phase. *See page 7 of ethical framework document for definition of validation phase.*
